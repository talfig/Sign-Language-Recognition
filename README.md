...
### 2. **PyTorch Hand Sign Classifier**:
   - The classification model is based on the **MobileNetV2** architecture, which has been fine-tuned for the task of hand sign recognition. MobileNetV2 is a lightweight model designed for mobile and embedded vision tasks, making it an efficient choice for real-time applications.
